...
Address._classifyFromVersion = function(buffer) {
  ...
  var prefix = buffer[0]; // komodo have one byte network prefix (!)
...
Address._transformBuffer = function(buffer, network, type) {
  ...
  info.hashBuffer = buffer.slice(1); // komodo have one byte network prefix (!)
...
Address._transformString = function(data, network, type) {
  ...
  addressBuffer = Base58Check.decode(data);
    ...
    addressBuffer = Buffer.from("123456789012345678901");
